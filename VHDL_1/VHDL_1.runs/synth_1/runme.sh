...
HD_PWD='C:/Users/someo/VHDL_1/VHDL_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log random_mode9.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source random_mode9.tcl
