...
HD_PWD='C:/Users/someo/VHDL_2/VHDL_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_control.tcl
